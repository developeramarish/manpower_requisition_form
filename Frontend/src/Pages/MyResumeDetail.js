...
const MyResumeDetail = () => {
  ...
  const [myresumeDetail, setmyresumeDetail] = useState([
    {
      SrNo: "1",
      ResumeName: "Ramksrishna",
      UploadedOn: "28-04-2023",
      UploadedBy: "Sweta",
      ResumeReviewer: "Dummy data",
      ResumeStatus: "Shortlisted",
      Reason: <InputTextarea placeholder="Enter Reason" rows={1} cols={25} />,
    },
    {
      SrNo: "2",
      ResumeName: "Ashutosh M",
      UploadedOn: "28-04-2023",
      UploadedBy: "Sweta",
      ResumeReviewer: "Dummy data",
      ResumeStatus: "Shortlisted",
    ...
    <div>
      ...
      >
        ...
        >
          ...
          ></Column>
          <Column
            field="ResumeReviewer"
            header="ResumeReviewer"
            body={FilterDemo}
            bodyClassName="font-bold"
            sortable
            style={{ width: "20%" }}
