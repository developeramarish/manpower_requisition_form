...
namespace MRF.API.Test.Controllers
{
    public class MrfresumereviewermapControllerTest
    {
        ...
        public MrfresumereviewermapControllerTest()
        {
            ...
            Controller = new MrfresumereviewermapController(fixture.MockUnitOfWork.Object, fixture.MockLogger.Object, fixture.MockEmailService.Object,fixture.MockHostEnvironment.Object, fixture.Mockconfiguration.Object);
        }
        ...
        public void GetResumeStatusDetailsById_ShouldReturnNoResult_WhenInputIsEqualToZero()
        {
            ...
            // Act
            var result = Controller.GetResumeStatusDetails(id, dashboard,roleId,userId);
