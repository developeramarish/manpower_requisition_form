...
namespace MRF.API.Controllers
{
    ...
    public class MrfdetailController : ControllerBase
    {
        ...
        public MrfdetaiResponseModel Post([FromBody] MrfdetailRequestModel request)
        {
            ...
            /*commented because Ref no generated by system and ReferenceNo blank on POST request*/
        ...
        {
            if (request.ResumeReviewerEmployeeId != 0)
            {
            ...
            if (request.InterviewerEmployeeId != 0)
            {
